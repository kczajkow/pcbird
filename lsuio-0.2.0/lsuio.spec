...
#Icon:
#URL:
#Packager: Hans J. Koch hjk@linutronix.de
...
Summary: List UIO devices.

%description
List UIO devices.
lsuio.spec.  Generated from lsuio.spec.in by configure.
Please edit lsuio.spec.in to add several more lines of description
